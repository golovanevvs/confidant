...
3. Добавить возможность удаления группы.
4. Добавить возможность удаления e-mail группы.
5. Добавить возможность удаления записи данных.
6. Добавить возможность редактирования записи данных.
7. Доработать синхронизацию:
...
8. Провести оптимизацию кода в части работ с ошибками.
9. Провести оптимизацию кода в части распределения задач между слоями.
10. Доработать в части обеспечения безопасности:
    - добавить шифрование e-mail.
11. Добавить возможность конфигурирования сервера через флаги, переменные окружения, JSON-файл.
12. Добавить для сервера поддержку SQLite.
13. Добавить лицензию MIT.
