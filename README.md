...
1. Внедрить поддержку протокола gRPC.
2. Расширить основную функциональность системы.
3. Продолжать оснащать код юнит-тестами.
4. Оснастить систему дополнительными видами тестирования: интеграционными и e2e-тестами.
5. Освоить применение Kubernetes для оркестрации контейнеров и повысить опыт управления производственными системами.
